...
export const NEON_HEADSTART_LINES = [
...
export const NEON_BROKE_LINE = "NEON FILTER NEEDS 50 SHEEBS — YOU'RE BROKE LOL"

// Chaser Beta specific pools
export const CHASER_BETA_OPENER_LINES = [
...
export const CHASER_BETA_RUNNER_GUN_TAUNTS = [
  "BACK UP, BOWL BOY!",
  "I FOUND A GUN! RUN!",
  "FLUSH THIS, TOILET!",
  "PEW! PERSONAL SPACE!",
...
export const CHASER_BETA_WIN_LINES = [
