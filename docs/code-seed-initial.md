# Ken's revision of gemini instructions for coding. 
...
*   **Backend & Networking:** FastAPI (Python) using WebSockets for real-time multiplayer syncing - *TBD, ROADMAP parking lot future*
*   **Database:** MongoDB *TBD, ROADMAP parking lot future* - use sqllite or in memory database HTML5 and cookies for state management. 
*   **Deployment Target:** nginx webserver on kenmacpherson.com website simple copy to #  ~/personal/website/kenmacpherson.com/skib-jay-dee-toilet-game/ -ci/cd pushes automatically to  https://kenmacpherson.com/skib-jay-dee-toilet-game/index.html

# refer to game design vibe .pdf 
- Skib-jay-dee-toilet game-init-v1.pdf
