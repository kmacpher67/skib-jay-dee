...
2026-09-20 | v0.4.77 | Implemented Boom Stick Slice C1 (Spawn and ammo state logic)
2026-09-20 | v0.4.77 follow-up | Completed Boom Stick C1 event-roll hooks, difficulty/Lucky cap helpers, duplicate pickup refresh, loaded-weapon vs shell pickup split, reserve/reload coverage, and `frontend/e2e/boom-stick-c1.spec.js`.
...
2026-08-07 | docs (Codex GPT-5) | audio-recording brief: added Alex-facing source-audio guide with naming, tone, and canonical-dialog pointers; no code
...
2026-08-11 | v0.4.76 | Heavy Plunger rebalance (GitHub issue #2): spawn chance 0.08 -> 0.045, added new AoE shit-stain slow-zone dropped on swing (the swing itself was already AoE; the stain did not exist in code before this).
2026-08-11 | docs (Claude Sonnet 5) | Correction pass: `roadmap-handoff-v0.4.76-plan.md`'s ready-queue ranking (and its stale claim that Micro-Skib/pose collapse/badge counts were unshipped) was wrong — verified against real code, all three shipped in v0.4.71/v0.4.72. Corrected `docs/roadmap.md`, `docs/update-directions.md`, `docs/next-agent-coding-brief.md`, `docs/next-agent-planning-brief.md`; left a correction note at the top of `roadmap-handoff-v0.4.76-plan.md` rather than deleting it.
