...
- The near-capture pause-card item from v0.4.5-plan
  ...
  path.
- Also still open: the v0.4.2-plan/v0.4.3-plan backlog, in order —
  extra-chaser speed ramp, Pipeworks's 4-chaser/max-speed clear
  condition, lvl2-video arrival-vs-clear timing fix, then death-visual
  overlap verification. Fully spec'd in
