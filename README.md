...
face upload. Multiplayer, role-swapping, and additional characters are
future phases (see [Roadmap](#roadmap) below).
...
SPRINT bottom-right to escape, get caught to see the jump-scare.
...
frontend/            Vite + React app
  src/GameEngine.js   Canvas game loop, joystick/sprint input, chase AI,
                      jump-scare camera zoom — plain JS, no React deps
  src/App.jsx         Main menu, face upload, mounts GameEngine
...
| Phase | Focus | Status |
|---|---|---|
| 1 | Core engine, one map, jump-scare, face upload | **Done** (this repo) |
| 2 | FastAPI WebSocket multiplayer, lobby, Skreem counter sync | Backend scaffolded, not wired up |
| 3 | More characters, abilities, role-swapping | Not started |
| 4 | MongoDB persistence, "World Star" UI polish, Skreem shop | Not started |
...
[docs/next-agent-brief.md](docs/next-agent-brief.md).
